...
print(df_homo)
latex_table <- xtable(df_homo, type = "latex", row.names = FALSE)
print(latex_table, file = "table_homo.tex", include.rownames = FALSE)

cat("\n=== s ===\n")
print(df_s)
digits <- c(0,2,2,2,2,2,2,2,2,2)
latex_table <- xtable(df_s, type = "latex", row.names = FALSE, digits = digits)
print(latex_table, file = "table_s.tex", include.rownames = FALSE)

cat("\n=== AICs ===\n")
print(df_AIC)
latex_table <- xtable(df_AIC, type = "latex", row.names = FALSE, digits = digits)
print(latex_table, file = "table_AIC.tex", include.rownames = FALSE)

cat("\n=== Δ AIC ===\n")
print(df_delta)
latex_table <- xtable(df_delta, type = "latex", row.names = FALSE, digits = digits)
print(latex_table, file = "table_delta.tex", include.rownames = FALSE)

cat("\n=== Parameter estimates ===\n")
print(df_params)
digits <- c(0,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
latex_table <- xtable(df_params, type = "latex", row.names = FALSE, digits = digits)
print(latex_table, file = "table_params.tex", include.rownames = FALSE)
